...
const FlowerIcon = () => (
   ...
   >
      ...
      <g
         fill="url(#gradient-flower-fixed)"
...
const PerplexityIcon = () => (
   ...
   >
      ...
      <rect
         ...
         height="256"
         rx="128"
         fill="url(#paint0_linear_601_4643-fixed)"
      ></rect>
      <rect
         width="256"
         height="256"
         rx="128"
         fill="url(#paint1_linear_601_4643-fixed)"
      ></rect>
      <path
         ...
         >
            ...
            <g>
               ...
               {outerIcons.map((icon, i) => {
                  ...
                  const angle2 =
                     (-90 + nextIndex * (360 / outerIcons.length)) *
                     (Math.PI / 180);
                  const x2 =
